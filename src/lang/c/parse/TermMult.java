...
public class TermMult extends CParseRule {
	...
	public void parse(CParseContext pcx) throws FatalErrorException {
		System.out.println(";;;parse-termMult");
	...
	public void semanticCheck(CParseContext pcx) throws FatalErrorException {
		...
		if (left != null && right != null) {
			...
			if (nt == CType.T_err) {
				pcx.warning(op.toExplainString() + "左辺の型[" + left.getCType().toString() + "]と右辺の型[" + right.getCType().toString() + "]はかけられません");
			}
	...
	public void codeGen(CParseContext pcx) throws FatalErrorException {
		...
		if (left != null && right != null) {
			...
			o.println("\tJSR MUL\t ; TermMult:掛け算へ移動<" + op.toString() + ">");
