...
public class Expression extends CParseRule {
	...
	public void parse(CParseContext pcx) throws FatalErrorException {
		...
		System.out.println(";;;parse-Experssion");
...
class ExpressionAdd extends CParseRule {
	...
	public void parse(CParseContext pcx) throws FatalErrorException {
		System.out.println(";;;parse-ExpressionAdd");
		// ここにやってくるときは、必ずisFirst()が満たされている
		CTokenizer ct = pcx.getTokenizer();
	...
	public void semanticCheck(CParseContext pcx) throws FatalErrorException {
		...
		//		T_err			T_int
			...
			{	CType.T_err,	CType.T_int ,  CType.T_pint,CType.T_int ,  CType.T_pint,CType.T_err ,  CType.T_err },  // T_int  int
			{	CType.T_err,	CType.T_pint , CType.T_err ,CType.T_pint ,  CType.T_err,CType.T_err ,  CType.T_err },   // T_pint int*
			{	CType.T_err,	CType.T_int ,  CType.T_pint,CType.T_int ,  CType.T_pint,CType.T_err ,  CType.T_err },  // T_Bint int[]
			{	CType.T_err,	CType.T_pint , CType.T_err ,CType.T_pint ,  CType.T_err,CType.T_err ,  CType.T_err },   // T_Bpint int*[]
		...
		if (left != null && right != null) {
			...
			if(lt>4 || rt>4) {
				pcx.fatalError("足し算の左辺か右辺の型がbooleanまたはvoidです");
			}
...
class ExpressionSub extends CParseRule {
	...
	public void semanticCheck(CParseContext pcx) throws FatalErrorException {
		...
		//		T_err			T_int
				...
				{	CType.T_err,	CType.T_pint , CType.T_int,CType.T_pint ,  CType.T_int,CType.T_err ,  CType.T_err},   // T_pint
				{	CType.T_err,	CType.T_int ,  CType.T_err,CType.T_int ,  CType.T_err,CType.T_err ,  CType.T_err},  // T_Bint int[]
				{	CType.T_err,	CType.T_pint , CType.T_int ,CType.T_pint ,  CType.T_int,CType.T_err ,  CType.T_err},   // T_Bpint int*[]
				{	CType.T_err,	CType.T_err , CType.T_err ,CType.T_err ,  CType.T_err,CType.T_err ,  CType.T_err },
				{	CType.T_err,	CType.T_err , CType.T_err ,CType.T_err ,  CType.T_err,CType.T_err ,  CType.T_err },
		};
		if (left != null && right != null) {
